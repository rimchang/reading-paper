...
(모든 valid padding을 same padding을 바꾸고 대신 1x1 conv stride 2를 적용하여 spatail resolution을 줄인다.. 근데 valid padding이 왜... miss aligned feature인 것이지? http://deeplearning.net/software/theano/tutorial/conv_arithmetic.html#convolution-arithmetic
