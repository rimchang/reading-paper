...
(모든 valid padding을 same padding을 바꾸고 대신 1x1 conv stride 2를 적용하여 spatail resolution을 줄인다.. 근데 valide padding이 왜... miss aligned feature인 것이지? http://deeplearning.net/software/theano/tutorial/conv_arithmetic.html#convolution-arithmetic
를 참고하면 알 수 있다.. valid 패딩의 경우를 살펴보면.. 다른것을 볼 수 있음)
